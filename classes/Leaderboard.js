...
class Leaderboard {
    ...
    static async findById(id) {
        try {
            ...
            logger.error(
                `Error finding leaderboard by ID ${id}: ${error.message}`
            );
            throw new Error(
                `Error finding leaderboard by ID: ${error.message}`
            );
        }
    }
    ...
    static async findByRole(roleId, top = 10) {
        try {
            ...
            throw new Error(
                `Error finding leaderboard by role: ${error.message}`
            );
        }
    }
    ...
    static async findByAliasName(aliasName) {
        try {
            ...
            throw new Error(
                `Error finding leaderboard by alias: ${error.message}`
            );
        }
    }
    ...
    static async getStats() {
        try {
            ...
            throw new Error(
                `Error getting leaderboard statistics: ${error.message}`
            );
        }
    }
    ...
    async approvePoints(criteria_id, reward_entry_id, status) {
        try {
            ...
            if (!rewardEntry) {
                logger.error(
                    `Reward entry not found with id: ${reward_entry_id}`
                );
                throw new ErrorResponse(
            ...
            const totalPoints =
                forApprovalPoints + approvedPoints + rejectedPoints;
