...
class Criteria {
  ...
  static async findAll(isManager = false) {
    const tableName = isManager ? this.managerTableName : this.memberTableName;
  ...
  static async findByDirectorApproval(director_approval) {
    ...
    const directorApprovalKey = new CriteriaTableSchema().getDirectorApproval();
