...
class ApprovalEntry {
    ...
    static async findById(id) {
        try {
            ...
            throw new Error(
                `Error finding approval entry by ID: ${error.message}`
            );
        }
    }
    ...
    static async findAll() {
        try {
            ...
            throw new Error(
                `Error finding all approval entries: ${error.message}`
            );
        }
    }
    ...
    static async updateApprovalStatusByRewardsId(
        ...
        try {
            ...
            console.error(
                'Error updating approval status by rewards id:',
                error
            );
            throw new Error(
    ...
    static async findByManagerId(manager_id, manager_approval_status) {
        try {
            ...
            if (manager_approval_status) {
                whereConditions['manager_approval_status'] =
                    manager_approval_status;
            }
    ...
    static async findByDirectorId(director_id, status, manager_id) {
        try {
            ...
            console.error(
                'Error finding approval entry by director ID:',
                error
            );
            throw new Error(
    ...
    static async managerApproval(
        ...
        try {
            ...
            throw new Error(
                `Error approving entry by manager: ${error.message}`
            );
        }
    }
    ...
    static async directorApproval(
        ...
        try {
            ...
            throw new Error(
                `Error approving entry by director: ${error.message}`
            );
        }
    }
