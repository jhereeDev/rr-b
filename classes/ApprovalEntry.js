  ...
  static async fetchAndFormatEntries(
    ...
    const query = database(this.tableName)
      .select(
        ...
        'approvalentry.*',
        'rewardsentry.*',
        'rewardpointscriteria.id AS criteria_id',
        'rewardpointscriteria.category',
        'rewardpointscriteria.accomplishment',
        'rewardpointscriteria.points',
        'rewardpointscriteria.guidelines',
      ...
      .join(
        ...
        'rewardsentry.criteria_id',
        '=',
        'rewardpointscriteria.id'
      )
      .join(
        'members',
